                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Add New Remark <a href="{{ route('remark.list') }}"><button
                                    ...
                                    <div class="col-12">
                                        <div class="tab-content dark-field" id="horizontal-wizard-tabContent">
                                            <div class="tab-pane fade show active" id="wizard-info" role="tabpanel"
                                                ...
                                                <form method="POST" action="{{ route('remark.store') }}"
                                                    ...
                                                    <div class="col-xl-6 col-sm-6">
                                                        ...
                                                        <select class="form-control form-select" name="project_id[]"
                                                            id="project_id" multiple required >
                                                    ...
                                                    <div class="col-xl-6 col-sm-6">
                                                        ...
                                                        <input class="form-control" id="remark"
                                                            value="{{ old('remark') }}" name="remark" type="text"
                                                    ...
                                                    <div class="col-xl-3 col-sm-3">
                                                        <div class="form-check checkbox checkbox-primary mb-0 mt-3">
                                                            <input class="form-check-input" name="status" id="status"
                                                                type="checkbox"
                                                                @if (old('status') == 1) checked="" @else checked="" @endif>
