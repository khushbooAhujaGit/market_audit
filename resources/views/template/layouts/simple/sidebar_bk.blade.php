            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            ...
                            </svg><span>Company Master          </span></a>
                        <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('template.list')}}">Activities</a></li>
                            <li><a href="{{route('template.create')}}">Create</a></li>
                            <li><a href="{{route('dropdown.list')}}">Activity Dropdown Question</a></li>
                            <li><a href="{{route('dropdown.create')}}">Create Dropdown</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list d-none"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            <svg class="stroke-icon">
                                <use href="../assets/svg/icon-sprite.svg#stroke-project"></use>
                            </svg>
                            <svg class="fill-icon">
